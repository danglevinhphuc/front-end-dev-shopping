...
import { actAddProductRequest, actUpdateProductRequest, actGetProductRequest } from '../ProductEditAction';

class ProductEditAction extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductEditAction);
